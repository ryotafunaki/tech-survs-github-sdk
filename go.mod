module github.com/ryotafunaki/tech-survs-github-sdk

go 1.22.5

require github.com/octokit/go-sdk v0.0.29
...
require (
	...
	github.com/microsoft/kiota-abstractions-go v1.8.0 // indirect
